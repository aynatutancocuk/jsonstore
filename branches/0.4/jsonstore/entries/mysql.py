...
class EntryManager(object):
    def __init__(self, location):
        # Create connection.
        params = split_location(location)
    ...
    def search(self, obj, flags=0, size=None, offset=0):
        ...
        # Build search query.
        query = ["SELECT id, entry, updated FROM store WHERE id IN (SELECT id FROM flat"]
